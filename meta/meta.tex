...
Note that a maximally consistent set is maximally not trivial if our logic permits it. In that case decidability already follows from completeness. Nonetheless, this suggests an extension of paraconsistent semantics with a decidability clause.
