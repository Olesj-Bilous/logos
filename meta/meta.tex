...
The following property allows us to apply rules of inference to propositions already inferred.
...
Note that every meaningful application of a rule of inference is marked by the extension of a set of inferred propositions.
